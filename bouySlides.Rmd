...
##Comparing Air Temp from 1985 to 2017
...
##Comparing Water Temp from 1985 to 2017

Statistical testing comparing water temperature in 1985 to 2017:
```{r, echo= FALSE}
t.test(mydata3$WTMP[1:90], mydata3$WTMP[8382:8744])
```
This data shows that there has also been a difference between the water temp in 1985 and the water temp in 2017
